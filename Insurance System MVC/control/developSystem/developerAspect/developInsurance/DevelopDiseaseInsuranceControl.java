...
public class DevelopDiseaseInsuranceControl extends DevelopSystem {

	// Component
	private DevelopInsuranceView view;
	
	@Override
	public BasicPanel getView() {this.view = new DevelopInsuranceView(this.actionListener, true); return this.view;}
