...
public class DevelopFireInsuranceControl extends DevelopSystem {
	
	// Component
	private DevelopInsuranceView view;
	
	@Override
	public BasicPanel getView() {this.view = new DevelopInsuranceView(this.actionListener, false); return this.view;}
