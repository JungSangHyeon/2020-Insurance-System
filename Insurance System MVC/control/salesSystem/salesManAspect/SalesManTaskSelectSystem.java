...
public class SalesManTaskSelectSystem extends SalesSystem {
	...
	@Override
	public BasicPanel getView() {return new SalesManTaskSelectView(this.actionListener);}
	
	@Override
	public DynamicSystem processEvent(ActionEvent e) {
		switch (SalesManTaskSelectView.EActionCommands.valueOf(e.getActionCommand())) {
